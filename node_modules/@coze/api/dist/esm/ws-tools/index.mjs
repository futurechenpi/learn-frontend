 ...
 */ class WavStreamPlayer {
   ...
   */ constructor({ sampleRate = 44100, enableLocalLoopback = false, defaultFormat = 'pcm', volume = 1.0 } = {}){
        ...
        if (isMobile()) this.prepareAudioUnlock();
    }
}
...
class WsChatClient extends chat_base {
    ...
    async connect() {
        ...
        var _event_data_input_audio, _event_data, _event_data_input_audio1, _event_data1, _event_data_output_audio, _event_data2, _event_data_output_audio1, _event_data3, _this_wavStreamPlayer, _this_wavStreamPlayer1, _event_data_turn_detection, _event_data4;
        ...
        setValueByPath(event, 'data.input_audio.sample_rate', (null === (_event_data = event.data) || void 0 === _event_data ? void 0 : null === (_event_data_input_audio = _event_data.input_audio) || void 0 === _event_data_input_audio ? void 0 : _event_data_input_audio.sample_rate) || 48000);
        this.inputAudioCodec = (null === (_event_data1 = event.data) || void 0 === _event_data1 ? void 0 : null === (_event_data_input_audio1 = _event_data1.input_audio) || void 0 === _event_data_input_audio1 ? void 0 : _event_data_input_audio1.codec) || 'pcm';
        this.outputAudioCodec = (null === (_event_data2 = event.data) || void 0 === _event_data2 ? void 0 : null === (_event_data_output_audio = _event_data2.output_audio) || void 0 === _event_data_output_audio ? void 0 : _event_data_output_audio.codec) || 'pcm';
        if ('opus' === this.outputAudioCodec) {
            var _event_data_output_audio_opus_config, _event_data_output_audio2, _event_data5;
            this.outputAudioSampleRate = (null === (_event_data5 = event.data) || void 0 === _event_data5 ? void 0 : null === (_event_data_output_audio2 = _event_data5.output_audio) || void 0 === _event_data_output_audio2 ? void 0 : null === (_event_data_output_audio_opus_config = _event_data_output_audio2.opus_config) || void 0 === _event_data_output_audio_opus_config ? void 0 : _event_data_output_audio_opus_config.sample_rate) || 24000;
            await this.initOpusDecoder();
        } else {
            var _event_data_output_audio_pcm_config, _event_data_output_audio3, _event_data6;
            this.outputAudioSampleRate = (null === (_event_data6 = event.data) || void 0 === _event_data6 ? void 0 : null === (_event_data_output_audio3 = _event_data6.output_audio) || void 0 === _event_data_output_audio3 ? void 0 : null === (_event_data_output_audio_pcm_config = _event_data_output_audio3.pcm_config) || void 0 === _event_data_output_audio_pcm_config ? void 0 : _event_data_output_audio_pcm_config.sample_rate) || 24000;
        }
        null === (_this_wavStreamPlayer = this.wavStreamPlayer) || void 0 === _this_wavStreamPlayer || _this_wavStreamPlayer.setDefaultFormat((null === (_event_data3 = event.data) || void 0 === _event_data3 ? void 0 : null === (_event_data_output_audio1 = _event_data3.output_audio) || void 0 === _event_data_output_audio1 ? void 0 : _event_data_output_audio1.codec) || 'pcm');
        ...
        this.turnDetection = (null === (_event_data4 = event.data) || void 0 === _event_data4 ? void 0 : null === (_event_data_turn_detection = _event_data4.turn_detection) || void 0 === _event_data_turn_detection ? void 0 : _event_data_turn_detection.type) || 'server_vad';
