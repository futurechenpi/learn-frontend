...
function get(obj, path) {
  ...
  const deepGet = (obj2, path2, index, arrayIndex) => {
    ...
    if (!path2[index]) {
      list.push(arrayIndex !== void 0 ? { v: obj2, i: arrayIndex } : obj2);
    } else {
      let key = path2[index];
      ...
      if (index === path2.length - 1 && (isString(value) || isNumber(value) || isBoolean(value))) {
        list.push(
          arrayIndex !== void 0 ? { v: toString(value), i: arrayIndex } : toString(value)
        );
...
function computeScoreSingle(result, { ignoreFieldNorm = Config.ignoreFieldNorm }) {
  let totalScore = 1;
