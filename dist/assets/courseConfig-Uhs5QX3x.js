const e={pageName:"HTML 基础学习",routeName:"learn-html",totalSteps:5,progressKey:"html",codeLanguage:"html",exerciseRouteName:"exercise-html",aiCourseName:"HTML",hasExerciseSection:!0,hasPreview:!1,completionMessage:"恭喜！HTML基础学习完成！",lessons:[{title:"HTML 简介和基础结构",difficulty:"入门",duration:"10分钟",content:`
        <h4>什么是HTML？</h4>
...
</html>`,exercise:{description:"创建一个简单的HTML页面，包含标题和段落。"},aiSuggestion:"HTML是网页的基础，建议先理解文档结构，然后学习常用标签。"},{title:"常用HTML标签",difficulty:"入门",duration:"15分钟",content:`
        <h4>标题标签</h4>
...
<img src="image.jpg" alt="示例图片">`,exercise:{description:"使用不同的HTML标签创建一个包含标题、段落、链接和图片的页面。"},aiSuggestion:"记住标签的语义化使用，选择合适的标签来表达内容的含义。"},{title:"列表和表格",difficulty:"入门",duration:"12分钟",content:`
        <h4>列表</h4>
        <p>HTML支持两种主要类型的列表：</p>
        <ul>
...
</table>`,exercise:{description:"创建一个包含列表和表格的页面，展示你的个人信息。"},aiSuggestion:"表格要使用语义化的标签，表头用th，数据用td，这样更利于屏幕阅读器理解。"},{title:"表单元素",difficulty:"初级",duration:"18分钟",content:`
        <h4>表单基础</h4>
        <p>表单用于收集用户输入：</p>
        <ul>
...
</form>`,exercise:{description:"创建一个联系表单，包含姓名、邮箱、电话和留言字段。"},aiSuggestion:"表单要设置合适的输入类型和验证属性，提升用户体验。"},{title:"语义化标签",difficulty:"初级",duration:"15分钟",content:`
        <h4>HTML5语义化标签</h4>
...
<footer>
    <p>&copy; 2024 我的网站</p>
</footer>`,exercise:{description:"使用语义化标签重新组织一个完整的网页结构。"},aiSuggestion:"语义化标签不仅让代码更易读，还能提升SEO和可访问性。"}]},i={pageName:"CSS 样式学习",routeName:"learn-css",totalSteps:4,progressKey:"css",codeLanguage:"css",exerciseRouteName:"exercise-css",aiCourseName:"CSS",hasExerciseSection:!0,hasPreview:!0,completionMessage:"恭喜！CSS学习完成！",lessons:[{title:"CSS 基础语法",difficulty:"入门",duration:"12分钟",content:`
        <h4>什么是CSS？</h4>
...
p {
    ...
    line-height: 1.6;
      ...
      `,exercise:{description:"使用CSS基础语法，创建一个包含标题和段落的简单页面，设置字体颜色、大小和行高。"}},{title:"选择器详解",difficulty:"入门",duration:"15分钟",content:`
        <h4>基本选择器</h4>
        <ul>
...
div > p { padding: 5px; }`,preview:`
      ...
      `,exercise:{description:"使用元素选择器、类选择器、ID选择器和后代/子选择器，为页面中的不同元素设置不同的样式。"}},{title:"盒模型和布局",difficulty:"初级",duration:"18分钟",content:`
        <h4>盒模型</h4>
...
.flex-container {
    ...
    align-items: center;
      ...
      `,exercise:{description:"使用盒模型属性（padding/border/margin）和Flex布局，创建一个包含卡片和水平导航栏的页面布局。"}},{title:"响应式设计",difficulty:"初级",duration:"20分钟",content:`
        <h4>媒体查询</h4>
...
@media (min-width: 1024px) {
    .container {
      ...
      `,exercise:{description:"使用媒体查询和弹性单位（rem/vw/vh），创建一个在手机、平板、桌面端都能良好显示的响应式页面。"}}]},t={pageName:"JavaScript 编程学习",routeName:"learn-javascript",totalSteps:5,progressKey:"javascript",codeLanguage:"javascript",exerciseRouteName:"exercise-js",aiCourseName:"JavaScript",hasExerciseSection:!0,hasPreview:!1,completionMessage:"恭喜！JavaScript学习完成！",lessons:[{title:"JavaScript 基础语法",difficulty:"入门",duration:"15分钟",content:`
        <h4>什么是JavaScript？</h4>
...
// 输出到控制台
console.log(name, age, number);`,exercise:{description:"使用 let/const/var 声明变量，定义不同数据类型的值，并在控制台输出它们。"}},{title:"函数和作用域",difficulty:"入门",duration:"18分钟",content:`
        <h4>函数定义</h4>
...
console.log(globalVar); // 可以访问
// console.log(localVar); // 错误：无法访问`,exercise:{description:"使用函数声明、函数表达式和箭头函数三种方式定义函数，理解全局作用域与局部作用域的区别。"}},{title:"对象和数组",difficulty:"初级",duration:"20分钟",content:`
        <h4>对象</h4>
...
console.log(upperFruits);`,exercise:{description:"创建一个包含多个属性的对象，以及一个数组，使用 push/forEach/map/filter 等方法对数据进行操作。"}},{title:"DOM操作",difficulty:"初级",duration:"22分钟",content:`
        <h4>什么是DOM？</h4>
...
button.addEventListener("click", function() {
    alert("按钮被点击了！");
});`,exercise:{description:"使用 DOM API 选择页面元素，修改其文本内容、样式和类名，并为按钮添加点击事件监听器。"}},{title:"异步编程",difficulty:"中级",duration:"25分钟",content:`
        <h4>异步编程概念</h4>
...
}`,exercise:{description:"使用 Promise 和 async/await 处理异步操作，包括定时器和 fetch 请求，正确处理成功和错误情况。"}}]},l={pageName:"Vue3 框架学习",routeName:"learn-vue3",totalSteps:6,progressKey:"vue3",codeLanguage:"vue",exerciseRouteName:"",aiCourseName:"Vue3",hasExerciseSection:!1,hasPreview:!1,completionMessage:"恭喜！Vue3学习完成！",lessons:[{title:"Vue3 简介和组合式API",difficulty:"入门",duration:"15分钟",content:`
        <h4>什么是Vue3？</h4>
...
<\/script>`},{title:"响应式数据",difficulty:"入门",duration:"18分钟",content:`
        <h4>响应式系统</h4>
...
<\/script>`},{title:"组件通信",difficulty:"初级",duration:"20分钟",content:`
        <h4>父子组件通信</h4>
        <p>Vue3提供了多种组件通信方式：</p>
...
<\/script>`},{title:"生命周期钩子",difficulty:"初级",duration:"16分钟",content:`
        <h4>生命周期概念</h4>
...
<\/script>`},{title:"路由和状态管理",difficulty:"中级",duration:"22分钟",content:`
        <h4>Vue Router</h4>
...
})`},{title:"高级特性和最佳实践",difficulty:"中级",duration:"25分钟",content:`
        <h4>Teleport传送门</h4>
...
<\/script>`}]},o={pageName:"React 框架学习",routeName:"learn-react",totalSteps:4,progressKey:"react",codeLanguage:"react",exerciseRouteName:"",aiCourseName:"React",hasExerciseSection:!1,hasPreview:!1,completionMessage:"恭喜！React学习完成！",lessons:[{title:"React 基础概念",difficulty:"入门",duration:"15分钟",content:`
        <h4>什么是React？</h4>
...
export default App`},{title:"组件和状态管理",difficulty:"入门",duration:"18分钟",content:`
        <h4>函数组件</h4>
...
export default Counter`},{title:"生命周期和副作用",difficulty:"初级",duration:"20分钟",content:`
...
export default Timer`},{title:"性能优化和最佳实践",difficulty:"中级",duration:"22分钟",content:`
        <h4>性能优化</h4>
        <ul>
...
export default List`}]},c={pageName:"TypeScript 类型安全学习",routeName:"learn-typescript",totalSteps:4,progressKey:"typescript",codeLanguage:"typescript",exerciseRouteName:"",aiCourseName:"TypeScript",hasExerciseSection:!1,hasPreview:!1,completionMessage:"恭喜！TypeScript学习完成！",lessons:[{title:"TypeScript 基础类型",difficulty:"入门",duration:"15分钟",content:`
        <h4>什么是TypeScript？</h4>
...
function greet(person: string): string {
  return 'Hello ' + person
}`},{title:"接口和类型别名",difficulty:"入门",duration:"18分钟",content:`
        <h4>接口 (Interface)</h4>
...
const user: User = { id: 1, name: '张三' }`},{title:"泛型和高级类型",difficulty:"初级",duration:"20分钟",content:`
        <h4>泛型 (Generics)</h4>
...
type PartialUser = Partial<{ id: number; name: string }>`},{title:"在Vue3中使用TypeScript",difficulty:"中级",duration:"22分钟",content:`
...
// 组合式 API 类型
import { Ref } from 'vue'
const count: Ref<number> = ref(0)`}]},a={pageName:"TailwindCSS 实用优先学习",routeName:"learn-tailwindcss",totalSteps:4,progressKey:"tailwindcss",codeLanguage:"html",exerciseRouteName:"",aiCourseName:"TailwindCSS",hasExerciseSection:!1,hasPreview:!1,completionMessage:"恭喜！TailwindCSS学习完成！",lessons:[{title:"TailwindCSS 基础概念",difficulty:"入门",duration:"12分钟",content:`
...
</div>`},{title:"布局和间距",difficulty:"入门",duration:"15分钟",content:`
        <h4>Flexbox布局</h4>
...
</div>`},{title:"响应式设计和状态",difficulty:"初级",duration:"18分钟",content:`
        <h4>响应式断点</h4>
...
<p class="text-gray-700 dark:sm:text-white mt-2">根据状态与断点改变样式</p>`},{title:"自定义和最佳实践",difficulty:"中级",duration:"20分钟",content:`
        <h4>配置文件</h4>
...
/* 组件提取 */
.btn { @apply px-4 py-2 rounded font-medium bg-blue-500 text-white hover:bg-blue-600; }`}]},n={html:e,css:i,javascript:t,vue3:l,react:o,typescript:c,tailwindcss:a};export{n as a,a as b,i as c,e as h,t as j,o as r,c as t,l as v};
